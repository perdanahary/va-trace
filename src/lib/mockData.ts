...
const mockOrderSeeds: Omit<Order, "status">[] = [
  ...
  // === Fulfillment Progress Seed Orders covering all OrderItemProgress states ===
  {
    ...
    items: [
      { id: "item-fs-01", productCode: "2026-00195039-0002", poLineNumber: "1", name: "TPOSM - Sunscreen Without Velcro - 0.7x2 m - Vinyl FF Frontlight 10 Oz - DSE12 25K", quantity: 80, deliveredQuantity: 0, status: "Accepted" },
      { id: "item-fs-02", productCode: "2026-00195039-0014", poLineNumber: "2", name: "GT Stand Alone - Tin Plate (H) - 100x200 cm - Sticker Blockout - DSE12 25K", quantity: 32, deliveredQuantity: 0, status: "Accepted" },
    ],
  },
  {
    id: "OR-2026-570002",
    ...
    items: [
      { id: "item-fs-03", productCode: "2026-00194983-0040", poLineNumber: "2", name: "TPOSM - Sunscreen Without Velcro - 0.7x2 m - Vinyl FF Frontlight 10 Oz - DPP12 20K", quantity: 180, deliveredQuantity: 0, status: "In Production" },
      { id: "item-fs-04", productCode: "2026-00194983-0041", poLineNumber: "3", name: "TPOSM - Sunscreen Without Velcro - 0.7x3 m - Vinyl FF Frontlight 10 Oz - DPP12 20K", quantity: 1200, deliveredQuantity: 200, status: "In Production" },
    ],
  },
  {
    id: "OR-2026-570003",
    ...
    items: [
      { id: "item-fs-05", productCode: "2026-00194988-0020", poLineNumber: "1", name: "GT Stand Alone - TTD Big (H) - 25.5x72.5 cm - Art Carton - MFM20", quantity: 43, deliveredQuantity: 43, status: "Ready to Ship" },
      { id: "item-fs-06", productCode: "2026-00194988-0022", poLineNumber: "3", name: "GT Stand Alone - TTD Fit (H) - 15x40 cm - Art Carton - MFM20", quantity: 463, deliveredQuantity: 0, status: "Ready to Ship" },
    ],
  },
  {
    id: "OR-2026-570004",
    ...
    items: [
      { id: "item-fs-07", productCode: "2026-00194984-0003", poLineNumber: "3", name: "TPOSM - Sunscreen Without Velcro - 0.7x3 m - Vinyl FF Frontlight 10 Oz - SPS12 15K", quantity: 600, deliveredQuantity: 300, status: "On Delivery" },
      { id: "item-fs-08", productCode: "2026-00194984-0004", poLineNumber: "4", name: "TPOSM - Sunscreen Without Velcro - 0.7x4 m - Vinyl FF Frontlight 10 Oz - SPS12 15K", quantity: 300, deliveredQuantity: 0, status: "On Delivery" },
    ],
  },
  {
    id: "OR-2026-570005",
    ...
    items: [
      { id: "item-fs-09", productCode: "2026-00194983-0060", poLineNumber: "1", name: "GT Stand Alone - Tin Plate (H) - 100x200 cm - Sticker Blockout - DPP12 20K", quantity: 337, deliveredQuantity: 337, status: "Delivered" },
      { id: "item-fs-10", productCode: "2026-00194983-0063", poLineNumber: "2", name: "GT Stand Alone - TTD Fit (H) - 15x40 cm - Art Carton - DPP12 20K", quantity: 1205, deliveredQuantity: 1205, status: "Delivered" },
    ],
  },
  {
    id: "OR-2026-570006",
    ...
    items: [
      { id: "item-fs-11", productCode: "2026-00194983-0052", poLineNumber: "1", name: "GT SRC - Snap Frame (V) - 80x40 cm - Photopaper - DPP12 20K", quantity: 150, deliveredQuantity: 0, status: "Waiting" },
      { id: "item-fs-12", productCode: "2026-00194983-0053", poLineNumber: "2", name: "GT SRC - Snap Frame (H) - 40x80 cm - Photopaper - DPP12 20K", quantity: 150, deliveredQuantity: 0, status: "Waiting" },
    ],
  },
  {
    id: "OR-2026-570007",
    ...
    items: [
      { id: "item-fs-13", productCode: "2026-00194983-0046", poLineNumber: "8", name: "TPOSM - Sticker - 40x40 cm - Sticker Chromo - DPP12 20K", quantity: 6900, deliveredQuantity: 6900, status: "Overdue" },
      { id: "item-fs-14", productCode: "2026-00194983-0049", poLineNumber: "9", name: "GT SRC - Shop Sign Pole (V) - 200x100 cm - Sticker Blockout - DPP12 20K", quantity: 72, deliveredQuantity: 0, status: "Overdue" },
    ],
  },
  {
    id: "OR-2026-570008",
    ...
    items: [
      { id: "item-fs-15", productCode: "2026-00194984-0023", poLineNumber: "1", name: "GT Stand Alone - TTD Big (H) - 25.5x72.5 cm - Art Carton - SPS12 15K", quantity: 51, deliveredQuantity: 0, status: "Urgent" },
      { id: "item-fs-16", productCode: "2026-00194984-0005", poLineNumber: "5", name: "TPOSM - Sunscreen Without Velcro - 1x2 m - Vinyl FF Frontlight 10 Oz - SPS12 15K", quantity: 40, deliveredQuantity: 0, status: "Urgent" },
    ],
  },
  {
    id: "OR-2026-570009",
    ...
    items: [
      { id: "item-fs-17", productCode: "2026-00195039-0015", poLineNumber: "13", name: "GT Stand Alone - TTD Big (H) - 25.5x72.5 cm - Art Carton - DSE12 25K", quantity: 52, deliveredQuantity: 52, status: "Delivered" },
      { id: "item-fs-18", productCode: "2026-00195039-0020", poLineNumber: "18", name: "WS Mitra Sampoerna - Header Backwall (H) - 48x97.5 cm - Photopaper - DSE12 25K", quantity: 16, deliveredQuantity: 0, status: "On Delivery" },
      { id: "item-fs-19", productCode: "2026-00194983-0061", poLineNumber: "21", name: "GT Stand Alone - TTD Big (H) - 25.5x72.5 cm - Art Carton - DPP12 20K", quantity: 112, deliveredQuantity: 0, status: "In Production" },
      { id: "item-fs-20", productCode: "2026-00194983-0062", poLineNumber: "22", name: "GT Stand Alone - TTD Medium (H) - 20x58 cm - Art Carton - DPP12 20K", quantity: 47, deliveredQuantity: 0, status: "Created" },
    ],
  },
];
